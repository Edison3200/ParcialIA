...
#es el nodo que almacena cada estado de puzzle
class Node:
...
#algoritmo de cálculo de distancia heuristico
...
#esta función crea el camino más pequeño
...
if __name__ == '__main__':
    #ESCRIBIR MATRIZ A RESOLVER '0' ES NONE O CASILLA EN BLANCO
    br = main([[1, 4, 2],
               [3, 0, 8],
               [5, 7, 6]])

    print('Pasos totales: ', len(br) - 1)
    print()
    ...
    print(dash + dash + right_junction, 'CON LA SERIE DE PASOS RESUELVES EL PUZZLE', left_junction + dash + dash)
